...
import { SortAsc, FileText } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="mb-12 text-center">
          ...
          <p className="text-slate-600 max-w-2xl mx-auto">
            Ebooks, guias, plantillas y recursos descargables.
            Material de referencia para tu crecimiento profesional.
          </p>
        </div>

        <div className="flex items-center justify-between mb-8">
          <p className="text-slate-600">
            {products.length} documentos disponibles
          </p>
        ...
        {loading ? (
          ...
          <div className="text-center py-16">
            ...
            <p className="text-slate-600">No hay PDFs disponibles</p>
          </div>
        ) : (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
